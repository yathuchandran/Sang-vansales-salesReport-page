...
function Body({outlet,warehouseId,outletid,setBodyData,tableData,newValue,setNewValue,trnsId}) {
...
const combinedBody = [...fixedFields]
  ...
  return (
   ...
   
    {
      ...
      {
        <MuiEditableTable bodyData={combinedBody} outlet={outlet} warehouseId={warehouseId}   outletid={outletid} setBodyData={setBodyData}  tableData={tableData}  newValue={newValue} setNewValue={setNewValue} trnsId={trnsId} />
        // <RoleSummary />
      }
